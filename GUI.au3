...
Func TabFavCreate()
	...
	Global $ComboFavDriveType = GUICtrlCreateCombo("", 204, 416, 160, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	Global $InputFavTCPathExe = GUICtrlCreateInput("", 180, 368, 152, 21)
	...
	Global $InputFavTCPathIni = GUICtrlCreateInput("", 180, 392, 152, 21)
...
Func TabAboutCreate()
	...
	Global $LabelAboutFM = GUICtrlCreateLabel("FolderMenu3 EX", 200, 156, 160, 31)
